    ...
    return (
      <div className="h-screen shadow-2xl" >
        <span className="h-4/5 flex flex-col justify-around items-center ">
              ...
              bg-clip-text text-transparent bg-gradient-to-l from-gray-400 to-black" data-aos="fade-right" >
          ...
          <span className="font-bold text-center sm:justify-center text-gray-400 text-sm sm:text-xl md:text-2xl" data-aos="fade-right">
          Getting Ready for the Next Generation and Future of the Internet</span>
          <span className="visible font-bold text-center sm:justify-center text-gray-400 text-sm sm:text-xl md:text-2xl" data-aos="fade-right">
