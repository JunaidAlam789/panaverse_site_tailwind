export default function Section2() {
    return (
      <div className="h-screen" >
        ...
        <div className="h-4/5 flex flex-col sm:flex-row sm:justify-center items-center
        border-gray-500  bg-gray-200 rounded-md shadow-md ">
                
            <p className="text-gray-800 bg-white font-bold text-2xl rounded-lg my-2 py-2 px-20">
            The Panaverse Community
            </p>
            
            <p className=" text-gray-500 flex-1 text-center p-4">
